...
const Register = () => {
  const { register, updateUser, setUser, googleSignUp } = use(AuthContext);
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-white to-slate-50 px-4">
      ...
      >
        ...
        <div className="mt-6 flex flex-col gap-3 items-center justify-center">
          <button
            type="submit"
            className="px-4 py-2 w-full rounded-lg bg-sky-600 text-white font-semibold hover:bg-sky-700 transition"
          >
            Create account
          </button>
